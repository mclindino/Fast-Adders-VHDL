...
usage -auto
set log file fv/RIPPLE_CARRY/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/RIPPLE_CARRY/rtl_to_g1.ovf
...
read design -rangeconstraint -configuration  -enumconstraint -golden -lastmod -noelab \
	-vhdl 93 \
		../rtl/RIPPLE_CARRY.vhd \
	-vhdl 93 \
		../rtl/FULL_ADDER.vhd

elaborate design -golden -root RIPPLE_CARRY

read design -verilog -revised -lastmod -noelab \
	-unzip fv/RIPPLE_CARRY/g1.v.gz

elaborate design -revised -root RIPPLE_CARRY
