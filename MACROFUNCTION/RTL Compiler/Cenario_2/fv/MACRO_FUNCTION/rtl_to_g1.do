...
usage -auto
set log file fv/MACRO_FUNCTION/rtl_to_g1.log -replace
// tclmode
...
vpx read guide file fv/MACRO_FUNCTION/rtl_to_g1.ovf
...
write hier_compare dofile fv/MACRO_FUNCTION/hier_rtl_to_g1.do \
...
run hier_compare fv/MACRO_FUNCTION/hier_rtl_to_g1.do
usage
